...
Модалки создавать в папке modals, название у файлов не должно отличаться от айди
модалок с `modal-`, названия писать в кебаб-кейсе, пример

файл модалки: `example.pug` , => id у модалки `#modal-example`
